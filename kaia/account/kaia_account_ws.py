...
class TestKaiaNamespaceAccountWS(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKaiaNamespaceAccountWS("test_kaia_getAccount_success_sca"))
        ...
        suite.addTest(TestKaiaNamespaceAccountWS("test_kaia_getAccountKey_success_eoa_with_code"))
        suite.addTest(TestKaiaNamespaceAccountWS("test_kaia_getAccountKey_success_sca"))
        ...
        suite.addTest(TestKaiaNamespaceAccountWS("test_kaia_isContractAccount_success_sca"))
        ...
        suite.addTest(TestKaiaNamespaceAccountWS("test_kaia_getCode_success_sca"))
