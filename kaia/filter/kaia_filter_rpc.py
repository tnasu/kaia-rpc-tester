...
class TestKaiaNamespaceFilterRPC(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_newPendingTransactionFilter_success_wrong_value_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_newPendingTransactionFilter_success"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_uninstallFilter_error_no_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_uninstallFilter_error_wrong_type_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_uninstallFilter_success_false"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_uninstallFilter_success"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_getFilterChanges_error_no_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_getFilterChanges_error_wrong_type_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_getFilterChanges_error_wrong_value_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_getFilterChanges_success"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_getFilterLogs_error_no_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_getFilterLogs_error_wrong_type_param"))
        suite.addTest(TestKaiaNamespaceFilterRPC("test_kaia_getFilterLogs_error_wrong_value_param"))
