...
class TestTxpoolNamespaceRPC(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestTxpoolNamespaceRPC("test_txpool_content_success_wrong_value_param"))
        suite.addTest(TestTxpoolNamespaceRPC("test_txpool_content_success"))
        suite.addTest(TestTxpoolNamespaceRPC("test_txpool_inspect_success_wrong_value_param"))
        suite.addTest(TestTxpoolNamespaceRPC("test_txpool_inspect_success"))
        suite.addTest(TestTxpoolNamespaceRPC("test_txpool_status_success_wrong_value"))
        suite.addTest(TestTxpoolNamespaceRPC("test_txpool_status_success"))
