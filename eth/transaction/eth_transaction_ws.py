...
class TestEthNamespaceTransactionWS(unittest.TestCase):
    ...
    def suite():
        ...
        # suite.addTest(TestEthNamespaceTransactionWS("test_eth_signTransaction_error_wrong_value_param"))
        # suite.addTest(TestEthNamespaceTransactionWS("test_eth_signTransaction_success"))
        suite.addTest(TestEthNamespaceTransactionWS("test_eth_createAccessList_success"))
        ...
        # suite.addTest(TestEthNamespaceTransactionWS("test_eth_sendRawTransaction_AccessList_success"))
        # suite.addTest(TestEthNamespaceTransactionWS("test_eth_sendRawTransaction_DynamicFee_error_wrong_prefix"))
        # suite.addTest(TestEthNamespaceTransactionWS("test_eth_sendRawTransaction_DynamicFee_success"))
        ...
        # suite.addTest(TestEthNamespaceTransactionWS("test_eth_call_success_insufficient_balance_sender"))
